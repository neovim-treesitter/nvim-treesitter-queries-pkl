# nvim-treesitter-queries-pkl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pkl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pkl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pkl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pkl",
...
- [ ] Changes are scoped to `pkl` — do not include files for other languages
